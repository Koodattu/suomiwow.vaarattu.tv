  ...
  const copy = useMemo(
    () =>
      JSON.stringify({
        ...
        singleChange: t("singleChange"),
        changeCountUnit: t("changeCountUnit"),
        characterCountUnit: t("characterCountUnit"),
        accountCountUnit: t("accountCountUnit"),
        moreMovers: t("moreMovers"),
