...
Status: research and design specification. This document describes proposed raid-specific card finishes; it does not implement or enable them.
...
| Raid | Proposed finish | Static identity | Idle | Hover | Intensity |
| --- | --- | --- | --- | --- | --- |
| Nerub-ar Palace | **Royal Silk** | Aubergine and black chitin lacquer, gold court accents, ultrafine pearlescent silk, and a few viscous Black Blood beads near the margins. | Highlights travel along individual web strands; silk flexes at different parallax depths; dark droplets creep extremely slowly. | Strands pull taut toward the pointer, flashing violet-gold iridescence, while one dark bead refracts the art beneath it. | Quiet |
| Liberation of Undermine | **Chrome Jackpot** | Tarnished chrome, oil-slick edges, lime and turquoise neon, marquee bulbs, and a subtle casino-diamond pattern. Unlike Disco, it should contain no field of projected colored squares. | Marquee bulbs chase, exhaust smoke puffs from the edges, spotlights sweep, and occasional sparks or fireworks appear behind the art. | A spotlight locks to the pointer, the chrome shifts from green to jackpot gold, and a localized sequence of reel-like light bands races past. | Spectacle |
...
| --- | --- |
| Void and Black Empire | Void remains cosmic absence and distortion; Black Empire uses architecture, red fog, and watching eyes. |
...
| Disco and Chrome Jackpot | Disco is mirror-ball projection; Chrome Jackpot is casino chrome, marquee bulbs, exhaust, and spotlights. |
| Golden and Gilded Tempest | Golden is precious foil; Gilded Tempest is wet carved architecture with rain, storm, and frost. |
| Holographic and Abyssal Pearl | Holographic uses spectral foil; Abyssal Pearl uses water refraction, caustics, and mother-of-pearl. |
...
| --- | --- |
| Material relief and directional sheen | Gorian Relic, Sanguine Velvet, Progenitor, Royal Silk |
| Sparks, embers, and heat distortion | Slagforged, Felscorched, Worldcore, Shadowflame, Emberbloom |
| Smoke, fog, and mist | Felscorched, Moonfall, Black Empire, Runebound, Emberbloom, Chrome Jackpot |
| Weather fields | Gilded Tempest rain, Primalstorm snow and ash, Runebound soul ash |
| Bubbles, droplets, and caustics | Abyssal Pearl, Toxic, Gilded Tempest |
| Organic growth and particles | Nightmare Bloom, Emberbloom, Royal Silk |
| Procedural lines and marks | Nightwell star maps, Uldir containment grids, Runebound chains and runes, Progenitor circuits, Royal Silk webs |
| Refraction and distortion | Abyssal Pearl water lens, Worldcore gravity lens, Black Empire perspective bend, Phaseglass chromatic phase split |
...
1. **Sanguine Velvet** — proves that a finish can feel premium without being loud.
2. **Abyssal Pearl** — establishes water, bubbles, caustics, and refraction.
3. **Slagforged** — establishes sparks, heat distortion, and molten seams.
4. **Royal Silk** — establishes web geometry, thread highlights, and organic refraction.
5. **Chrome Jackpot** — establishes neon, smoke, spotlights, and chrome.
6. **Phaseglass** — establishes fractured glass, chromatic displacement, and deep parallax.
7. **Nightmare Bloom** — establishes organic growth, spores, and pulsing veins.
