...
export type CcgPackCreditSource = "duplicate_milestone" | "duplicate_backfill" | "duplicate" | "login_conversion" | "admin" | "raid_rollover" | "twitch_reward" | "pickem_reward" | "supporter_creation";
...
const CcgPackCreditSchema = new Schema<ICcgPackCredit>(
  {
    ...
    source: { type: String, enum: ["duplicate_milestone", "duplicate_backfill", "duplicate", "login_conversion", "admin", "raid_rollover", "twitch_reward", "pickem_reward", "supporter_creation"], required: true },
