...
export type CcgLedgerAction = "daily_grant" | "pack_open" | "card_acquire" | "duplicate_reward" | "guest_claim" | "login_conversion" | "admin_adjustment" | "redeem_code";
...
const CcgLedgerEntrySchema = new Schema<ICcgLedgerEntry>(
  {
    ...
    action: {
      type: String,
      enum: ["daily_grant", "pack_open", "card_acquire", "duplicate_reward", "guest_claim", "login_conversion", "admin_adjustment", "redeem_code"],
      required: true,
      index: true,
    },
