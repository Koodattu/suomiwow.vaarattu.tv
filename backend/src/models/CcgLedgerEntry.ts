...
export type CcgLedgerAction = "daily_grant" | "pack_open" | "card_acquire" | "duplicate_reward" | "guest_claim" | "login_conversion" | "admin_adjustment" | "redeem_code" | "raid_rollover" | "twitch_reward" | "pickem_reward" | "supporter_creation";
...
const CcgLedgerEntrySchema = new Schema<ICcgLedgerEntry>(
  {
    ...
    action: {
      type: String,
      enum: ["daily_grant", "pack_open", "card_acquire", "duplicate_reward", "guest_claim", "login_conversion", "admin_adjustment", "redeem_code", "raid_rollover", "twitch_reward", "pickem_reward", "supporter_creation"],
      required: true,
      index: true,
    },
