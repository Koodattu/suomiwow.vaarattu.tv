...
export const CCG_LEADERBOARD_FULL_SCHEDULE = { cron: "7 5 * * *", localTime: "05:07" } as const;
...
export const CCG_PACK_RULE_VERSION = "pack-v20-community-completion-nudge";
...
const CCG_CONFIGURED_SET_DEFINITIONS = [
  ...
  },
  {
    ...
    mark: "TVA",
    accent: "#8CE52B",
    glow: "rgba(140, 229, 43, 0.38)",
    customFinish: { key: "toxic", hardPity: CCG_CUSTOM_FINISH_HARD_PITY },
    crop: cropWithHorizontalRange(18, 86, 50, 1.1, 10),
  },
