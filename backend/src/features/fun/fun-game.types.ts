...
export function isBossMechanicDifficulty(value: unknown): value is BossMechanicDifficulty {
  return typeof value === "string" && (BOSS_MECHANIC_DIFFICULTIES as readonly string[]).includes(value);
}
